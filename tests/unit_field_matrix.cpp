...
typedef boost::mpl::list< bfl::bitset<int32_t>> test_types; // bfl::bitset<int8_t>, bfl::bitset<int16_t>,  // bfl::bitset<int>bfl::matrix<bfl::bitset<int8_t>>, 
...
BOOST_AUTO_TEST_CASE_TEMPLATE(test02_constructor, T, test_types) {
  { bfl::matrix<T> mat(2, 3);
    std::cout << mat;
      T mbitset(31);
      mbitset.set(1, 1);  mbitset.set(2, 1);  mbitset.set(30, 1);  
